    ...
    child: Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          IconButton(
            icon:(isPressed)? const Icon(Icons.bookmark_border,color: Colors.white,size: 28,):
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //Title
          const Text("What Interior Designer should Care About",
            style: TextStyle(
                fontSize: 30,
                fontWeight: FontWeight.bold,
                color: Colors.black
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(image: NetworkImage("https://images.unsplash.com/photo-1517365830460-955ce3ccd263?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"))
                ),
              ),
              const SizedBox(width: 10,),
              const Text("Daina Cruz",style: TextStyle(
                  fontSize: 14,
                  color: Colors.black,
                  fontWeight: FontWeight.bold
              ),),
