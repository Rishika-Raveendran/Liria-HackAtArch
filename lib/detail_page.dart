    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          //Title
          const Text("Why The Freelance Life May Get Easier",
            style: TextStyle(
                fontSize: 30,
                fontWeight: FontWeight.bold,
                color: Colors.black
            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(image: NetworkImage("https://images.unsplash.com/photo-1506919258185-6078bba55d2a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"))
                ),
              ),
              const SizedBox(width: 10,),
              const Text("Ted Milano",style: TextStyle(
                  fontSize: 14,
                  color: Colors.black,
                  fontWeight: FontWeight.bold
              ),),
