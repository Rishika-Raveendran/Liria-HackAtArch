...
class PCOSForumDetailPage extends StatefulWidget {
  const PCOSForumDetailPage({Key? key}) : super(key: key);

  @override
  _PCOSForumDetailPageState createState() => _PCOSForumDetailPageState();
}

var PCOSForumPostArr = [
  PCOSForumPostEntry(
      "Devika Baiju :",
  ...
  PCOSForumPostEntry(
      ...
      "Postpartum depression can occur any time in the first 12 months after birth.  If your doctor says you can only get postpartum depression in the first few weeks or months after birth, he or she is wrong. For more on this, read Does Postpartum Depression Only Occur in the Weeks After Baby is Born?  Also, you can get PCOS with any child, regardless of whether it is your first or fifth or somewhere in between."),
  PCOSForumPostEntry(
      "Meenaskshi K :",
      "Do I have to take medication to be treated for postpartum depression or anxiety?",
      "No.  There are a variety of treatments for PCOS, postpartum anxiety, postpartum OCD, etc, including therapy and/or medication.  You should work with your doctor to identify the best treatment options for you, and then be open to trying other things if the methods you choose don’t work."),
  PCOSForumPostEntry(
      "Rakesh Ravi :",
      "I’m a dad or partner.  How do I help someone going through PCOS?",
...
class _PCOSForumDetailPageState extends State<PCOSForumDetailPage> {
  @override
    ...
    var responses = Container(
        ...
        child: ListView.builder(
          itemBuilder: (BuildContext context, int index) =>
              PCOSForumPost(PCOSForumPostArr[index]),
          itemCount: PCOSForumPostArr.length,
        ));
...
class PCOSForumPostEntry {
  late final String username;
  late final String hours;

  late final String text;

  PCOSForumPostEntry(this.username, this.hours, this.text);
}

class PCOSForumPost extends StatelessWidget {
  String addedAnswer = "";
  final PCOSForumPostEntry entry;

  PCOSForumPost(this.entry, {Key? key}) : super(key: key);
